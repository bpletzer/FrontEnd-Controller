        ...
        $('#EqBTN', elem).click(function() {
            ...
            if(clicked == false) {
                ...
                function audioAv(event) {
                    var fb = event.frameBuffer, signal = new Float32Array(fb.length / channels), magnitude;
                    ...
                    for(var i = 0; i < fft.spectrum.length; i++) {
                        ...
                        //oscillograph Ausschlag :S
                        //animate this stf for rly n1 disco effects :S
                        $(liArray[i]).animate({
                            paddingLeft : magnitude + (i) + "",
                            color : "rgb(15, 99, 30)"
                        }, {
                            duration : 2,
                            queue : false,
                        ...
                        $(liArray[i]).css({
                            ...
                            backgroundColor : "rgb(" + Math.floor(Math.random() * 32) + "," + +Math.floor(Math.random() * 32) + "," + +Math.floor(Math.random() * 32) + ")"
                        });
                    }
                }//End audioAvailable
